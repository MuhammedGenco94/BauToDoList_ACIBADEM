...
namespace BauToDoList.Controllers
{
    public class ApplicationUsersController : Controller
    {
        ...
        {
            return View(await db.Users.ToListAsync());  //  ApplicationUsers, Eski hali
        }
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            ApplicationUser applicationUser = await db.Users.FirstOrDefaultAsync(u => u.Id == id);  //  FindAsync(id);     
            if (applicationUser == null)
            {
                return HttpNotFound();
            }
